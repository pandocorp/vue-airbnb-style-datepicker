(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('date-fns/format'), require('date-fns/sub_months'), require('date-fns/add_months'), require('date-fns/get_days_in_month'), require('date-fns/last_day_of_month'), require('date-fns/get_month'), require('date-fns/set_month'), require('date-fns/get_year'), require('date-fns/set_year'), require('date-fns/is_same_month'), require('date-fns/is_same_day'), require('date-fns/add_days'), require('date-fns/sub_days'), require('date-fns/add_weeks'), require('date-fns/sub_weeks'), require('date-fns/start_of_month'), require('date-fns/start_of_week'), require('date-fns/end_of_week'), require('date-fns/is_before'), require('date-fns/is_after'), require('date-fns/is_valid'), require('v-click-outside')) :
  typeof define === 'function' && define.amd ? define(['date-fns/format', 'date-fns/sub_months', 'date-fns/add_months', 'date-fns/get_days_in_month', 'date-fns/last_day_of_month', 'date-fns/get_month', 'date-fns/set_month', 'date-fns/get_year', 'date-fns/set_year', 'date-fns/is_same_month', 'date-fns/is_same_day', 'date-fns/add_days', 'date-fns/sub_days', 'date-fns/add_weeks', 'date-fns/sub_weeks', 'date-fns/start_of_month', 'date-fns/start_of_week', 'date-fns/end_of_week', 'date-fns/is_before', 'date-fns/is_after', 'date-fns/is_valid', 'v-click-outside'], factory) :
  (global.vueAirbnbStyleDatepicker = factory(global.dateFns.format,global.dateFns.subMonths,global.dateFns.addMonths,global.dateFns.getDaysInMonth,global.dateFns.lastDayOfMonth,global.dateFns.getMonth,global.dateFns.setMonth,global.dateFns.getYear,global.dateFns.setYear,global.dateFns.isSameMonth,global.dateFns.isSameDay,global.dateFns.addDays,global.dateFns.subDays,global.dateFns.addWeeks,global.dateFns.subWeeks,global.dateFns.startOfMonth,global.dateFns.startOfWeek,global.dateFns.endOfWeek,global.dateFns.isBefore,global.dateFns.isAfter,global.dateFns.isValid,global.vClickOutside));
}(this, (function (format,subMonths,addMonths,getDaysInMonth,lastDayOfMonth,getMonth,setMonth,getYear,setYear,isSameMonth,isSameDay,addDays,subDays,addWeeks,subWeeks,startOfMonth,startOfWeek,endOfWeek,isBefore,isAfter,isValid,vClickOutside) { 'use strict';
